...
def configured_pages(stem: str, key: str, page_count: int) -> list[int]:
    ...
    R23 source loci cannot be mapped safely to final reader pages until the
    ...
    for stem in CONFIG["stems"]:
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "reflow_note": (
                f"Candidate and authority page counts are recorded above; every candidate page was inspected, including all pages directly affected by the {CONFIG['operation_count']} mapped More Algebra operations."
            ),
        })
