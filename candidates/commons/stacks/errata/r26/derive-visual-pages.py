...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R26 source-page derivation requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Derive final R26 correction-sensitive reader pages from smoothing.tex SyncTeX data."
    )
