...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R26 rendering requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Render the sealed R26 candidate PDF and its configured high-resolution pages."
    )
