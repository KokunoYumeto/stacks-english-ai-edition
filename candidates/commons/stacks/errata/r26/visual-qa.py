...
def configured_pages(stem: str, key: str, page_count: int) -> list[int]:
    ...
    R26 source loci cannot be mapped safely to final reader pages until the
    payload has been built. The build operator must therefore record the Smoothing
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record R26 structural and manual visual QA after the render inspection is complete."
    )
