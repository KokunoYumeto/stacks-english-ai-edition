...
codimension $0$ points in $V$ and these are locally finite by
...
such that $\nu_V \circ g^\nu = g \circ \nu_U$, see
Morphisms, Lemma \ref{morphisms-lemma-normalization-normal}
part (4) applied to the composition $U^\nu \to U \to V$,
...
\medskip\noindent
What we have shown in the previous paragraph is this: for every algebraic
...
Definition \ref{spaces-properties-definition-dimension-local-ring}).
\item Let $f : Z \to X$ be a morphism. Assume $Z$ is a normal algebraic space
