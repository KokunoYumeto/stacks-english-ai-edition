...
HIGH_RES_PAGES: dict[str, list[int]] = {}
HIGH_RES_REVIEW_PAGES: dict[str, list[int]] = {
    "derived": [15, 17, 24, 25, 27, 28, 31, 33, 34, 36, 38, 39, 41, 42],
}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "All candidate pages were generated at 180 dpi; every correction-sensitive page and representative transition pages were manually inspected at that resolution",
    ...
    for stem in CONFIG["stems"]:
        ...
        high_res_evidence = []
        for page_number in HIGH_RES_PAGES.get(stem, list(range(1, state["pages"] + 1))):
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "manual_findings": {
                ...
                "high_resolution_pages_inspected": HIGH_RES_REVIEW_PAGES[stem],
                "clipping": 0,
                "overlap": 0,
