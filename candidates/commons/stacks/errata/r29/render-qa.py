...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R29 rendering requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Render the sealed R29 candidate PDF and its configured high-resolution pages."
    )
