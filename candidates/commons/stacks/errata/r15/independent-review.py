...
def main() -> int:
    ...
    candidate_pdf, authority_pdf = ROOT / "builds" / "brauer.pdf", ROOT / "builds" / "brauer.authority.pdf"
    ...
    render_pdf = render_manifest.get("pdfs", {}).get("brauer", {})
