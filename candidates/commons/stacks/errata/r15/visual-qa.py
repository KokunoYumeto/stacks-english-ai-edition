...
HIGH_RES_PAGES = {"brauer": list(range(1, 11))}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "All ten pages, including every correction-sensitive locus, were manually inspected at 180 dpi",
    ...
    for stem in CONFIG["stems"]:
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "reflow_note": (
                f"Candidate and authority page counts are recorded above; every candidate page was inspected, including all pages directly affected by the {CONFIG['operation_count']} mapped Brauer operations."
            ),
        })
