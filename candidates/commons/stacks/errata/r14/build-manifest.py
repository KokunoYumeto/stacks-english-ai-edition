    ...
    manifest = {
        ...
        **{key: evidence(path) for key, path in singled.items()},
        ...
        "unresolved_defects": [
            ...
            f"The frozen producer packet closes {first_producer} through {last_producer}: {closure['accepted']} rows are accepted, {closure['rejected']} is rejected, and none is aliased or unresolved.",
