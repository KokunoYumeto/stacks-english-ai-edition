...
def configured_pages(stem: str, key: str, page_count: int) -> list[int]:
    ...
    R27 source loci cannot be mapped safely to final reader pages until the
    payload has been built. The build operator must therefore record the Modules
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record R27 structural and manual visual QA after the render inspection is complete."
    )
