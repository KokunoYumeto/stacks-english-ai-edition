...
if tuple(CONFIG["stems"]) != (STEM,):
    raise AssertionError("R27 validation requires the single configured modules stem")
STRUCTURE_PATTERNS = {
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the complete sealed R27 candidate evidence chain.")
    parser.parse_args()
    ...
    try:
        ...
        adjudication = json.loads((ROOT / "R27_MODULES_ADJUDICATION_SPEC.json").read_text(encoding="utf-8"))
