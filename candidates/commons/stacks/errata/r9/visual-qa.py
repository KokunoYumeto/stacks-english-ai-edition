...
HIGH_RES_PAGES = {
    "algebra": [1, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443, 467],
}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first and last pages plus the complete changed-render band 432--443 were manually inspected at 180 dpi",
