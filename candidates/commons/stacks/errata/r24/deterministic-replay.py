...
def main() -> int:
    ...
    rows = []
    passed = True
    for phase, public_name in (("candidate", "spaces-duality.pdf"), ("authority", "spaces-duality.authority.pdf")):
        first = args.first_private_build_root / f"spaces-duality.{phase}.pdf"
