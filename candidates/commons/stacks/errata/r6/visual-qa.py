...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first and last pages plus the complete changed-render band 281--304 and convergence page 305 were manually inspected at 180 dpi",
