...
HIGH_RES_PAGES = {"homology": list(range(1, 83))}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "All 82 pages, including every correction-sensitive locus, were manually inspected at 180 dpi",
    ...
    for stem in CONFIG["stems"]:
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "reflow_note": (
                f"Candidate and authority page counts are recorded above; every candidate page was inspected, including all pages directly affected by the {CONFIG['operation_count']} mapped Homology operations."
            ),
        })
