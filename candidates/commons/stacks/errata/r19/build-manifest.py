    ...
    manifest = {
        ...
        **{key: evidence(path) for key, path in singled.items()},
        ...
        "unresolved_defects": [
            ...
            f"The bounded intake closes {first_producer} through {last_producer}: {closure['accepted']} rows are accepted, {closure['prior_overlay_aliases']} are rejected aliases of prior admitted overlays, and none is unresolved.",
