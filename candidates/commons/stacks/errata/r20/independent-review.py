...
def main() -> int:
    ...
    candidate_pdf, authority_pdf = ROOT / "builds" / "derived.pdf", ROOT / "builds" / "derived.authority.pdf"
    ...
    render_pdf = render_manifest.get("pdfs", {}).get("derived", {})
