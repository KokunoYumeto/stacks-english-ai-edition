...
\begin{reference}
\cite[(5.3.1), Proposition 5.3.2, and Corollaries 5.3.4 and 5.3.12]{EGA1}
\end{reference}
...
\begin{proof}
All four assertions follow from the universal property of fibre products.
...
$X_{S'}$ and $Y_{S'}$ are $\text{id}_{X_{S'}}$ and $f_{S'}$.
\end{proof}
