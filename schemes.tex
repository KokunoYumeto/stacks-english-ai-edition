...
\end{reference}
\begin{history}
The cited corollary proves surjectivity on global sections for the quotient
$\mathcal{O}_X^p/\mathcal{F}$ on an affine classical variety by vanishing of
$H^1(X,\mathcal{F})$. The equivalence below identifies global sections with
the corresponding module functor and gives the same exactness for arbitrary
