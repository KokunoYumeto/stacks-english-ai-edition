...
\begin{enumerate}
\item $U \to S$ is quasi-projective,
...
that follow from the algebraic-stack and moduli-space argument; it does
not assert either of those two scheme-theoretic refinements. Compare
