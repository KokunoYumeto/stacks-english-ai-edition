...
\end{reference}
\begin{history}
The cited remark announces that the affine module--sheaf correspondence must
be modified for coherent sheaves on projective space. The proposition below
makes the modification precise: one uses finitely generated graded modules,
quotients by the modules invisible in high degree, and recovers a sheaf from
the graded family of twisted global sections rather than from ordinary global
sections alone.
\end{history}
Let $A$ be a graded ring such that $A_0$ is Noetherian and $A$ is generated
