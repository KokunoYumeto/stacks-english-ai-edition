...
\end{reference}
\begin{history}
The cited result proves that the standard affine covering computes the
cohomology of a coherent algebraic sheaf on classical projective space and
deduces vanishing above its dimension. Part (2) below retains this bound over
an arbitrary Noetherian base ring, while the other parts add generation,
finiteness, and eventual twisted vanishing not asserted there.
\end{history}
