...
- Completed checkpoint: Chapter I, Section 3, no. 23, printed pages 199--216.
- Reviewed decisions: 66 (31 equivalent, 22 stronger, 6 extensions,
  5 new-statement decisions, 1 historical reference, 1 outside scope).
- Current Stacks references added: 37 across `sheaves.tex`, `modules.tex`,
  `coherent.tex`, and `cohomology.tex`.
- New Stacks statements: 4, each with a complete proof and no assigned tag.
...
- Next unit: `fac:I:3:no:24` (exact sequence, general case).
