...
\ref{theorem-oka-cartan-coherence}; compare
\cite[Chapter V, Section 5.6, p. 219]{Tohoku}.
...
\ref{coherent-lemma-tensor-hom-coherent}; the displayed isomorphism therefore
gives coherence of the target as well.
\end{proof}
...
$$
All these dimensions are finite by Grauert's finiteness theorem for coherent
analytic cohomology on compact complex spaces
\cite[Hauptsatz I, p. 57]{Grauert-direct-image}.
