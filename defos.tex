...
$X_q \to S_q$, starting with $X_1 = Y$.

Suppose $X_q$ has been constructed. Apply Cotangent
...
\ref{coherent-lemma-algebraize-flat-formal-scheme-H2}, the system $(X_q)$
algebraizes to a projective flat morphism $X \to \Spec(A)$. The smooth
locus is an open neighbourhood of the closed fibre by
