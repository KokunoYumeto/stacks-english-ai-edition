...
\item For a nonzero finite $A$-module $N$ the algebra $B = \text{End}_A(N)$ is a
...
$k$-algebra, then the multiplication map $B \otimes_k C \to A$ is an isomorphism,
...
\begin{enumerate}
\item $A$ is a finite central simple $k$-algebra,
