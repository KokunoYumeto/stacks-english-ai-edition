...
HIGH_RES_PAGES = {
    "algebra": [1, 427, 428, 429, 430, 431, 432, 467],
}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first and last pages plus the complete changed-render band 427--432 were manually inspected at 180 dpi",
