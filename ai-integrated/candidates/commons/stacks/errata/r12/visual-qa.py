...
HIGH_RES_PAGES = {"algebra": [1, *range(440, 467)]}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first page plus the complete correction-sensitive tail 440--466 were manually inspected at 180 dpi",
