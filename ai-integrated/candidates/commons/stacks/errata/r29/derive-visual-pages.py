...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R29 source-page derivation requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Derive final R29 correction-sensitive reader pages from sites-modules.tex SyncTeX data."
    )
