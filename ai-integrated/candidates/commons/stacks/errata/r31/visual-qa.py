...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record R31 structural and manual visual QA after the render inspection is complete."
    )
    ...
    report = {
        ...
        "adverse_evidence": [
            ...
            "The standalone candidate retains exactly the frozen authority's cross-chapter unresolved-reference and citation multisets; the reopened prose correction introduces no reference-target delta.",
        ],
    }
