...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R31 SyncTeX build requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create a private SyncTeX-enabled replay of the sealed R31 candidate PDF."
    )
    ...
    (work / ".r31-synctex-build.json").write_text(
