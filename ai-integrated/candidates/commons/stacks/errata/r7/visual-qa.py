...
HIGH_RES_PAGES = {
    "algebra": [1, *range(301, 312), *range(423, 428), 466],
}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first and last pages plus the complete changed-render bands 301--311 and 423--427 were manually inspected at 180 dpi",
