...
EXPECTED_PDF_SHA256 = "9B47224CB45CCD09E59DB7AC682E5EF941FDDA863D54425EA90906F6FB038C0A"
...
def main() -> int:
    ...
    source = work / "more-algebra.tex"
    pdf = work / "more-algebra.pdf"
    synctex = work / "more-algebra.synctex.gz"
