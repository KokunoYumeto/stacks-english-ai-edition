...
HIGH_RES_PAGES = {
    "algebra": [1, 440, 441, 442, 443, 444, 445, 446, 447, 448,
                449, 450, 451, 452, 453, 454, 455, 466],
}
...
def main() -> int:
    ...
    report = {
        ...
        "render_protocol": {
            ...
            "high_resolution_review": "The first and last pages plus the complete changed-render band 440--455 were manually inspected at 180 dpi",
    ...
    for stem in CONFIG["stems"]:
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "reflow_note": (
                f"Candidate and authority page counts are recorded above; every candidate page was inspected, including all pages directly affected by the {CONFIG['operation_count']} mapped Algebra operations."
            ),
        })
