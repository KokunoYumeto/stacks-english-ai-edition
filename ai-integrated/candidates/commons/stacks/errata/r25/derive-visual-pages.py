...
if len(CONFIG["stems"]) != 1:
    raise AssertionError("R25 source-page derivation requires exactly one configured stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Derive final R25 correction-sensitive reader pages from artin.tex SyncTeX data."
    )
