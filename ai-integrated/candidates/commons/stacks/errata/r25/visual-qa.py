...
def configured_pages(stem: str, key: str, page_count: int) -> list[int]:
    ...
    R25 source loci cannot be mapped safely to final reader pages until the
    payload has been built. The build operator must therefore record the Artin
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record R25 structural and manual visual QA after the render inspection is complete."
    )
