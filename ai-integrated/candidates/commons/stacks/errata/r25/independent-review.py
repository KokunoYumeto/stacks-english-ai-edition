...
if tuple(CONFIG["stems"]) != (STEM,):
    raise AssertionError("R25 independent replay requires the single configured artin stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Perform the independent adverse replay for sealed R25 evidence.")
