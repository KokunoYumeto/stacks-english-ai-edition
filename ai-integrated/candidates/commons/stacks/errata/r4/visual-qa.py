...
HIGH_RES_PAGES = {
    "topology": [1, 18, 23, 36, 64],
    "sheaves": [1, 36, 53, 54],
    "sites": [1, 13, 50, 79, 89, 113, 114],
}
    ...
    for stem in CONFIG["stems"]:
        ...
        report["pdfs"].append({
            ...
            **state,
            ...
            "reflow_note": (
                "The corrected sheaves build is one page longer than its authority control; all 54 pages, including the resulting final one-entry References page, were inspected and are unclipped and readable."
                if stem == "sheaves" else
                "Candidate and authority control have the same page count; all candidate pages were inspected."
            ),
        })
