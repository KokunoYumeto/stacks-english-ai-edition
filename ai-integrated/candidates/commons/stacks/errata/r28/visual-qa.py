...
def configured_pages(stem: str, key: str, page_count: int) -> list[int]:
    ...
    R28 source loci cannot be mapped safely to final reader pages until the
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record R28 structural and manual visual QA after the render inspection is complete."
    )
