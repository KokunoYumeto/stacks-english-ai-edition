...
if tuple(CONFIG["stems"]) != (STEM,):
    raise AssertionError("R26 independent replay requires the single configured smoothing stem")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Perform the independent adverse replay for sealed R26 evidence.")
