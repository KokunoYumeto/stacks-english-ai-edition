...
| Errata | Composed into this source tree | 17 admitted batches containing 444 stable correction IDs; R18 is the next candidate namespace, not an admitted overlay | [Registry](ai-integrated/registry/overlays.json) · [candidate evidence](ai-integrated/candidates/commons/stacks/errata/) |
