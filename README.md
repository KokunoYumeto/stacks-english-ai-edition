...
- Registered overlays: **ten** (`stacks-errata-a04446e-r1`,
  ...
  `stacks-errata-a04446e-r8`, `stacks-errata-a04446e-r9`, and
  `stacks-errata-a04446e-r10`), each admitted from a manifest-complete candidate
  after independent replay.
- Active candidate-namespace leases: **four** (`fac`, `tohoku`, `gaga`,
  `errata/r11`). The first three are held by task
  `019fca5a-c29e-7330-acdc-c93f4a3dc9fb`; `errata/r11` is held by canon task
