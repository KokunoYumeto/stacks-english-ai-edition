...
- Registered overlays: **nineteen** (`stacks-errata-a04446e-r1`,
  ...
  `stacks-errata-a04446e-r18`, and `stacks-errata-a04446e-r19`), each admitted
  from a manifest-complete candidate
  after independent replay.
- Active candidate-namespace leases: **four** (`fac`, `tohoku`, `gaga`,
  `errata/r20`). The first three are held by task
  `019fca5a-c29e-7330-acdc-c93f4a3dc9fb`; `errata/r20` is held by canon task
