...
- Registered overlays: **seven** (`stacks-errata-a04446e-r1`,
  `stacks-errata-a04446e-r2`, `stacks-errata-a04446e-r3`,
  `stacks-errata-a04446e-r4`, `stacks-errata-a04446e-r5`, and
  `stacks-errata-a04446e-r6`, and `stacks-errata-a04446e-r7`), each admitted from a manifest-complete
  candidate after independent replay.
- Active candidate-namespace leases: **four** (`fac`, `tohoku`, `gaga`,
  `errata/r8`). The first three are held by task
  `019fca5a-c29e-7330-acdc-c93f4a3dc9fb`; `errata/r8` is held by canon task
